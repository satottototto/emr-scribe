...
- **Page navigation & management** — a footer with previous / next, a tappable "n / total" jump box, and a page menu to delete, move up, or move down the current page (a non-scroll way to move around long notes).
